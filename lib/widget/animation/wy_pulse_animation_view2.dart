...
class WYPulseAnimationView2 extends StatefulWidget {
  WYPulseAnimationView2({
    Key? key,
    required this.child,
  ...
  @override
  State<WYPulseAnimationView2> createState() => _JhPulseAnimationView2State();
}

/// State class, where the magic happens
class _JhPulseAnimationView2State extends State<WYPulseAnimationView2> with SingleTickerProviderStateMixin {
