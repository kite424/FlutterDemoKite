...
class _BaseTabBarState extends State<BaseTabBar> {
  ...
  _createItem(String label, String imgPath, iconColor, {bool showBadge = false}) {
    var item = BottomNavigationBarItem(
      label: label,
      icon: WYAssetImage(imgPath, width: _iconWH),
      activeIcon: _addAnimation(label, WYAssetImage('${imgPath}_on', width: _iconWH, color: iconColor)),
    );
    return item;
  }
