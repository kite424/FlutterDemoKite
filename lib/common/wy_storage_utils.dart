...
import 'package:flutter_kite/common/wy_encrypt_utils.dart';

/// AES 加密存储
class WYAESStorageUtils {
  /// 存 String
  static Future<bool>? saveString(String key, String value) {
    key = WYEncryptUtils.aesEncrypt(key);
    value = WYEncryptUtils.aesEncrypt(value);
  ...
  static String? getString(String key) {
    ...
    if (enValue.isNotEmpty) {
      return WYEncryptUtils.aesDecrypt(enValue);
    }
    return null;
  }
