...
import 'package:flutter_kite/common/wy_storage_utils.dart';

import '../../common/wy_color_utils.dart';
import '../../common/wy_status_bar_utils.dart';
...
class ThemeProvider extends ChangeNotifier {
  ...
  void setTheme([ThemeMethod themeMode = ThemeMethod.themeLight]) {
    WYAESStorageUtils.saveString(_appThemeKey, _methodValues[themeMode]!);
    notifyListeners();
  }
  ...
  ThemeMode getThemeMode() {
    final String theme = WYAESStorageUtils.getString(_appThemeKey) ?? '';
    switch (theme) {
      case _themeLight:
...
class MyThemes {
  static final lightTheme = ThemeData(
    primarySwatch: WYColorUtils.materialColor(KColors.kThemeColor),
  ...
  static getThemeData(Color themeColor, {bool isDarkMode = false}) {
    ...
    return ThemeData(
      primarySwatch: WYColorUtils.materialColor(themeColor),
      ...
      appBarTheme: AppBarTheme(
        systemOverlayStyle: WYStatusBarUtils.getStatusBarStyle(isDark: isDarkMode),
