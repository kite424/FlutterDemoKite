...
class WYPulseAnimationView extends StatefulWidget {
  const WYPulseAnimationView({
    Key? key,
    required this.child,
  ...
  @override
  State<WYPulseAnimationView> createState() => _JhPulseAnimationViewState();
}

class _JhPulseAnimationViewState extends State<WYPulseAnimationView> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant WYPulseAnimationView oldWidget) {
